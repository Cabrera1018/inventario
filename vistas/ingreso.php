...
<div class="box-header with-border">
  <h1 class="box-title">Entradas <button class="btn btn-success" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i>Agregar</button></h1>
