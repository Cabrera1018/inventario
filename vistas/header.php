...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      ...
      <span class="logo-mini"><b style="color: #BFFF00;">Safe</b> Wallet</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b style="color: #BFFF00;">Safe </b> Wallet</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  Safe Wallet- Tu Dinero, Tu Prioridad.
                  <small>:D</small>
                </p>
              </li>
              <!-- Menu Footer-->
...
if ($_SESSION['compras']==1) {
  echo ' <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="ingreso.php"><i class="fa fa-circle-o"></i> Ganancias</a></li>
