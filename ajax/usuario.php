...
switch ($_GET["op"]) {
	...
	if (!empty($idusuario)|| !empty($nombre) || !empty($tipo_documento) || !empty($num_documento)|| !empty($direccion) || !empty($telefono)|| !empty($email)|| !empty($cargo)|| !empty($login)|| !empty($clave)|| !empty($imagen)) {
