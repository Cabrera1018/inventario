...
$pdf->Cell(58,6,'Name',1,0,'C',1);
$pdf->Cell(50,6,utf8_decode('Categorie'),1,0,'C',1);
$pdf->Cell(30,6,utf8_decode('Code'),1,0,'C',1);
$pdf->Cell(12,6,'Stock',1,0,'C',1);
$pdf->Cell(35,6,utf8_decode('Description'),1,0,'C',1);
$pdf->Ln(10);
...
echo "You don't have access to see the report";
}
